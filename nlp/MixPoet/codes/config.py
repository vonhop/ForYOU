...
hparams = HParams(
    ...
    vocab_path="./nlp/MixPoet/corpus/vocab.pickle",
    ivocab_path="./nlp/MixPoet/corpus/ivocab.pickle",
    train_data="./nlp/MixPoet/corpus/semi_train.pickle",
    valid_data="./nlp/MixPoet/corpus/semi_valid.pickle",
    model_dir="./nlp/MixPoet/checkpoint/",
    data_dir="./nlp/MixPoet/data/",
    ...
    train_log_path="../nlp/MixPoet/log/mix_train_log.txt",
    valid_log_path="../nlp/MixPoet/log/mix_valid_log.txt",
    fig_log_path="../nlp/MixPoet/log/",
    ...
    dae_save_epoches=2,
    dae_train_log_path="../nlp/MixPoet/log/dae_train_log.txt",
    dae_valid_log_path="../nlp/MixPoet/log/dae_valid_log.txt",
    #------------------------------------------
    ...
    cl_save_epoches=2,
    cl_train_log_path="../nlp/MixPoet/log/cl_train_log.txt",
    cl_valid_log_path="../nlp/MixPoet/log/cl_valid_log.txt",
)
